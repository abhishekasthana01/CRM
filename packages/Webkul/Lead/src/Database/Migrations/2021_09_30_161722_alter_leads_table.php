...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('leads', function (Blueprint $table) use ($tablePrefix) {
            if (DB::getDriverName() !== "sqlite") $table->dropForeign($tablePrefix.'leads_lead_stage_id_foreign');
    ...
    {
        Schema::table('leads', function (Blueprint $table) {
            if (DB::getDriverName() !== "sqlite") $table->dropForeign(DB::getTablePrefix().'leads_lead_pipeline_stage_id_foreign');
            if (DB::getDriverName() !== "sqlite") $table->dropColumn('lead_pipeline_stage_id');
